...
app.index_string = """<!DOCTYPE html>
		<html>
			...
			<noscript><div><img src="https://mc.yandex.ru/watch/57472615" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
			<!— /Yandex.Metrika counter —>
			{%metas%}
			<title>{%title%}</title>
			{%favicon%}
...
app.layout = html.Div(
    [
        ...
        # progress bar
	html.Div([html.Div(html.H6('Прогресс прохождения курса'), style={"margin-left": "3px"}), 
		  html.Div(html.Div(
					[
