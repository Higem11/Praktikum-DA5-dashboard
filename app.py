        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        html.A(
                            html.Button("Praktikum", id="learn-more-button"),
                ...
                html.Div(
                    ...
                    [
                        html.A(
                            ...
                            href="https://docs.google.com/forms/d/e/1FAIpQLScwuHIxILazCP_K6_kM-R-aNdlVPblrM1_dddvNF_lrC8G6Eg/viewform",
                        )
                    ],
                    id="1button",
                ),
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Div(
                                    [html.H6(id = 'met'), html.P("Количество респондентов")],
                                    id="wells",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id = 'man'), html.P("Количество мужчин")],
                                    id="gas",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id = 'woman'), html.P("Количество женщин")],
                                    id="oil",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H6(id = 'mean_age'), html.P("Средний возраст респондента")],
                                    id="water",
                                    className="mini_container",
                                ),
                            ],
...
def update_graph_live(n):
    ...
    #1
    fig.add_trace(go.Scatter(x=df['timestamp'], y=df['quality_rate'], marker_color = 'crimson', hoverinfo='y'))
    # indicator of change
    ...
    # mean_line
    #3
    fig.add_trace(go.Scatter(x=list(df['timestamp']), y=([df['quality_rate'].mean()] * len(df.timestamp)),
...
def update_graph_live(n):
    ...
    #1
    fig.add_trace(go.Scatter(x=df['timestamp'], y=df['job_rate'], marker_color = 'crimson', hoverinfo='y'))
    # indicator of change
    ...
    # mean_line
    #3
    fig.add_trace(go.Scatter(x=list(df['timestamp']), y=([df['job_rate'].mean()] * len(df.timestamp)),
                            line=dict(color="#6b648f", dash="dash"), name = 'mean', mode="lines"))
...
def update_graph_live(n):
    ...
    #1
    fig.add_trace(go.Scatter(x=df['timestamp'], y=df['review'], marker_color = 'crimson', hoverinfo='y'))
    # indicator of change
    ...
    # mean_line
    #3
    fig.add_trace(go.Scatter(x=list(df['timestamp']), y=([df['review'].mean()] * len(df.timestamp)),
                            line=dict(color="#6b648f", dash="dash"), name = 'mean', mode="lines"))
